                            ...
                            <tr>
                              ...
                              <td>
                                <div class="form-button-action">
                                  <a href="<?= base_url('departemen/detail/' . $d['id_departemen']) ?>"
                                    title="Lihat"
                                    class="btn btn-link btn-primary btn-lg"><i
                                      class="fa fa-eye"></i></a>
                                  <a href="<?= base_url('departemen/edit/' . $d['id_departemen']) ?>"
        ...
        <div class="custom-content">
          ...
          <script>
            ...
            $('#edit-selected').click(function() {
              ...
              if (ids.length === 0) {
                return alert('Pilih minimal satu departemen untuk diedit.');
              }
              // Kirim ke controller edit_multiple dengan parameter id yang dipisahkan koma
              window.location.href = "<?= base_url('departemen/edit_multiple/') ?>" + ids.join(',');
            });
