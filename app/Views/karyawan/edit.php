...
<body>
    ...
    <div class="container mt-5">
        <div class="card">
            ...
            <div class="card-body">
                <form id="karyawanForm" action="<?= base_url('karyawan/edit/' . $data['id_karyawan']) ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="sn" name="sn" value="<?= old('sn', $data['sn']) ?>"
                            required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="status" name="status" required>
                            ...
                            <option value="PHK" <?= ($data['status'] == 'PHK') ? 'selected' : '' ?>>PHK</option>
                            <option value="Cuti" <?= ($data['status'] == 'Cuti') ? 'selected' : '' ?>>Cuti
                            </option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="doh" name="doh"
